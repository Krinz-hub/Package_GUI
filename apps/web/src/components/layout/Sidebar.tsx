...
export const Sidebar: React.FC<SidebarProps> = ({ currentTab, onTabChange, overview }) => {
  ...
  const navItems = [
    { id: 'overview', label: 'Overview', icon: LayoutDashboard },
    {
      ...
      badgeColor: updatesCount > 0 ? 'bg-blue-500/20 text-blue-400 border border-blue-500/30' : undefined,
    },
    { id: 'brew', label: 'Homebrew', icon: Boxes, badge: brewCount > 0 ? brewCount : undefined },
    { id: 'npm', label: 'npm Global', icon: Terminal, badge: npmCount > 0 ? npmCount : undefined },
    { id: 'pip', label: 'Python (pip)', icon: Terminal, badge: pipCount > 0 ? pipCount : undefined },
    { id: 'cargo', label: 'Cargo (Rust)', icon: Terminal, badge: cargoCount > 0 ? cargoCount : undefined },
  ];
